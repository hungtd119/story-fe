...
export class StoryDetailComponent implements OnInit {
  ...
  gotoConfigPages(storyId: number, storyType: string) {
    this.router.navigate(['dashboard/story-config-pages', storyId, storyType]);
  }
  gotoConfigPage(pageId: number, storyType: string) {
    this.router.navigate(['dashboard/story-config-page', pageId, storyType]);
  }
}
